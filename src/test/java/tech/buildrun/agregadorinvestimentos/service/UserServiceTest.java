...
class UserServiceTest {
    ...
    class createUser {
        ...
        void shouldThorwExceptionWhenErrosOccurs() {
            // Arrange(Organizar)
    ...
    class getUserById {
        ...
        void shoulGetUserByIdWithSuccessWhenOptionalIsPresent() {
            //Arrange
            var user = new User(
                    "password",
                    null,
        ...
        void shoulGetUserByIdWithSuccessWhenOptionalIsEmpty() {
            //Arrange
    ...
    class updateUserById {
        ...
        void shouldUpdateUserByIdWhenUserExistsAndUsernameAndPasswordIsFilled() {
            ...
            var argumentCaptorValues = userArgumentCaptor.getValue();

            assertEquals(updateuserDto.username(), argumentCaptorValues.getUsername());
            assertEquals(updateuserDto.password(), argumentCaptorValues.getPassword());
